...
也可对照站内其它 JSON 样例：[notes/data.json](/pages/notes/data.json)。

---

## 5. 媒体嵌入：图片

下面用站内已有图片，检查 **正文内嵌图**（固定模式下单独成行默认居中；显式 `media-sm` 则小号左对齐）。

![示例静帧 1](/content/media/image/1.jpg)

第二张（PNG，**仅缩小** class=`media-size-sm`，不指定左右 → 固定模式下应仍居中）：

<img class="media-size-sm" src="/content/media/image/2.png" alt="示例静帧 2（小号、不指定左右）" />

第三张（**小号左对齐** class=`media-sm`，固定/铺满/窄屏均左贴）：

<img class="media-sm" src="/content/media/image/3.png" alt="示例静帧 3（小号左对齐）" />

第四张（**真 SVG 矢量图**，纯 path/圆/多边形，无位图嵌套；与位图同放 `content/image/`）：

![纯矢量示意 vector-demo](/content/media/image/vector-demo.svg)

徽章样例（真 SVG 文本+形状，同样可缩放）：

<img class="media-size-sm" src="/content/media/image/webmd-badge.svg" alt="WebMD SVG badge" />

单独全页预览（侧栏打开资源页）也可点：

- [1.jpg 全页预览](/pages/media/image/1.jpg/)  
- [2.png 全页预览](/pages/media/image/2.png/)  
- [3.png 全页预览](/pages/media/image/3.png/)  
- [vector-demo.svg 全页预览](/pages/media/image/vector-demo.svg/)  
- [webmd-badge.svg 全页预览](/pages/media/image/webmd-badge.svg/)  

---

## 6. 媒体嵌入：视频

图生视频的结果形态就是视频。文内 `<video src="/content/...">` 与全页预览共用 **`_Res_<文件名>/poster.jpg`** 封面（有文件才绑定；scan/build 本机有 ffmpeg 时可自动抽帧）。

### 6.1 样例 A（**小号左对齐**）

<video class="media-video media-sm" controls playsinline preload="metadata">
  <source src="/content/media/video/The_River_Wears_the_Sun.mp4" type="video/mp4" />
  你的浏览器不支持 video 标签；可直接打开
  <a href="/content/media/video/The_River_Wears_the_Sun.mp4">The_River_Wears_the_Sun.mp4</a>
</video>

- 全页预览：[The_River_Wears_the_Sun.mp4](/pages/media/video/The_River_Wears_the_Sun.mp4/)

### 6.2 样例 B（中文文件名，默认铺满栏宽）

<video class="media-video" controls playsinline preload="metadata">
  <source src="/content/media/video/赤坂のカーブ.mp4" type="video/mp4" />
  你的浏览器不支持 video 标签；可直接打开
  <a href="/content/media/video/赤坂のカーブ.mp4">赤坂のカーブ.mp4</a>
</video>

- 全页预览：[赤坂のカーブ.mp4](/pages/media/video/赤坂のカーブ.mp4/)  
- 相关音频（对照多媒体路由）：[赤坂のカーブ.mp3](/pages/media/audio/赤坂のカーブ.mp3/)
...
| [script/game_ui_design.py](/pages/scripts/game_ui_design.py/) | 代码资源页 |
| [samples/office/sample.pdf](/pages/samples/office/sample.pdf/) | PDF 内嵌预览 |
