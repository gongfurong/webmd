...
![示例静帧 1](/content/image/1.jpg)

第二张（PNG，**仅缩小** class=`media-size-sm`，不指定左右 → 固定模式下应仍居中）：

<img class="media-size-sm" src="/content/image/2.png" alt="示例静帧 2（小号、不指定左右）" />

第三张（**小号左对齐** class=`media-sm`，固定/铺满/窄屏均左贴）：

<img class="media-sm" src="/content/image/3.png" alt="示例静帧 3（小号左对齐）" />

第四张（**真 SVG 矢量图**，纯 path/圆/多边形，无位图嵌套；与位图同放 `content/image/`）：

![纯矢量示意 vector-demo](/content/image/vector-demo.svg)

徽章样例（真 SVG 文本+形状，同样可缩放）：

<img class="media-size-sm" src="/content/image/webmd-badge.svg" alt="WebMD SVG badge" />

单独全页预览（侧栏打开资源页）也可点：

- [1.jpg 全页预览](/f/image/1.jpg/)  
- [2.png 全页预览](/f/image/2.png/)  
- [3.png 全页预览](/f/image/3.png/)  
- [vector-demo.svg 全页预览](/f/image/vector-demo.svg/)  
- [webmd-badge.svg 全页预览](/f/image/webmd-badge.svg/)  
...
<video class="media-video media-sm" controls playsinline preload="metadata">
  <source src="/content/video/The_River_Wears_the_Sun.mp4" type="video/mp4" />
  你的浏览器不支持 video 标签；可直接打开
  <a href="/content/video/The_River_Wears_the_Sun.mp4">The_River_Wears_the_Sun.mp4</a>
</video>
...
<video class="media-video" controls playsinline preload="metadata">
  <source src="/content/video/赤坂のカーブ.mp4" type="video/mp4" />
  你的浏览器不支持 video 标签；可直接打开
  <a href="/content/video/赤坂のカーブ.mp4">赤坂のカーブ.mp4</a>
</video>
